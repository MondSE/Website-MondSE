      ...
      <div className="qualification__container container">
        <div className="qualification__tabs">
          <div
            ...
            onClick={() => toggleTab(1)}
          >
            <i className="ri-pencil-ruler-2-line qualification__icon"></i>
            Education
          </div>
          ...
          <div
            ...
            onClick={() => toggleTab(3)}
          >
            <i className="ri-folder-user-line qualification__icon"></i>{" "}
            Certificate
          </div>
        </div>
        ...
        <div className="qualification__sections">
          ...
          >
            <div className="qualification__data">
              ...
              <div className="qualification__info reveal3">
                ...
                <span className="qualification__subtitle">
                  Philippines - Cisco Networking Academy
                </span>
            ...
            <div className="qualification__data">
              ...
              <div className="qualification__info reveal3">
                <h3 className="qualification__title">
                  Associate Degree in Computer Systems Servicing
                </h3>
                <span className="qualification__subtitle">
                  Philippines - GKA
                </span>
          ...
          >
            <div className="qualification__data3">
              <div className="qualification__info reveal3">
                ...
                <br />
                <span
                  className="qualification__button2"
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/file/d/1L5WgsFQL2Nq4XPiS80dIWmmrv0vR98eu/view?usp=sharing",
                      "_blank"
                    )
                  }
                >
                  View More{" "}
                  <i className="ri-arrow-right-line qualification__button2-icon"></i>
                </span>
              </div>
              ...
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/file/d/1XSn9dRIXEwDGKGT5olTQbgoyJW6EoYpP/view?usp=sharing",
                      "_blank"
                    )
                  }
                >
            ...
            <div className="qualification__data3">
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/file/d/13V3B1Nxx6qgSUrWfbCjJka8MCuKbgxQG/view?usp=sharing",
                      "_blank"
                    )
                  }
                >
              ...
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/file/d/1khmLffH34hff2QbrIPdy_EORHG-pIEMy/view?usp=sharing",
                      "_blank"
                    )
                  }
                >
            ...
            <div className="qualification__data3">
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/file/d/1cbM_gJnJdK-Wx-7BeQKONOiA5bULjCYw/view?usp=sharing",
                      "_blank"
                    )
                  }
                >
              ...
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.testdome.com/certificates/4ab31b60d2d142f29168cb1ab3061a86",
                      "_blank"
                    )
                  }
                >
            ...
            <div className="qualification__data3">
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.testdome.com/certificates/10d63437a0134c8bb576ac47bde04f96",
                      "_blank"
                    )
                  }
                >
              ...
              <div className="qualification__info reveal3">
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.testdome.com/certificates/1c8499ef94e040b98e6761b0dfdc3fe9",
                      "_blank"
                    )
                  }
                >
